...
void handleRoot() {
  ...
  Serial.println(msg);
  data = msg;
    if(msg=="red"||msg=="Red"||msg==" Red")
  {
    colorRed();
  }else if(msg=="green"||msg=="Green"||msg==" Green")
  {
   colorGreen();
  }else if(msg=="blue"||msg=="Blue"||msg==" Blue")
  {
   colorBlue();
  }else if(msg=="white"||msg=="White"||msg==" White")
  {
   colorWhite();
  } else if(msg=="cyan"||msg=="Cyan"||msg==" Cyan")
  {
   colorCyan();
  } else if(msg=="magenta"||msg=="Magenta"||msg==" Magenta")
  {
   colorMagenta();
  }else if(msg=="yellow"||msg=="Yellow"||msg==" Yellow")
  {
   colorYellow();
  }else if(msg=="black"||msg=="Black"||msg==" Black")
  {
   colorBlack();
  }else if(msg=="chasered"||msg=="Chasered"||msg==" Chasered")
  {
   colorChaseRed();
  }else if(msg=="chasegreen"||msg=="Chasegreen"||msg==" Chasegreen")
  {
   colorChaseGreen();
  }else if(msg=="chaseblue"||msg=="Chaseblue"||msg==" Chaseblue")
  {
   colorChaseBlue();
  }else if(msg=="chasewhite"||msg=="Chasewhite"||msg==" Chasewhite")
  {
   colorChaseWhite();
  }else if(msg=="random"||msg=="Random"||msg==" Random")
  {
   colorRandom();
  }else if(msg=="rainbow"||msg=="Rainbow"||msg==" Rainbow")
  {
   colorRainbow();
  }else if(msg=="rainbowcycle"||msg=="Rainbowcycle"||msg==" Rainbowcycle")
  {
   colorRainbowCycle();
  }else if(msg=="chaserainbow"||msg=="Chaserainbow"||msg==" Chaserainbow")
  {
   colorChaseRainbow();
  }
}
